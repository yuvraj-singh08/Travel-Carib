...
import { createChargeService, createCheckoutSessionService, handleCoinbaseWebhookService, handleStripeWebhook } from "../services/paymentService";
...
export const coinbaseWebhook = async (req, res) => {
    try {
        let data;
        const COINBASE_WEBHOOK_SECRET = process.env.COINBASE_WEBHOOK_SECRET as string;
